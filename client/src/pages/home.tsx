      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="container px-4 relative z-20 max-w-5xl mx-auto">
          ...
          >
            ...
            <motion.h1 variants={fadeIn} className="text-4xl md:text-6xl lg:text-7xl font-family-display font-bold leading-tight bg-gradient-to-b from-white to-white/70 bg-clip-text text-transparent mb-8 relative z-10">
            ...
            <motion.div variants={fadeIn} className="flex flex-col items-center gap-4 justify-center pt-8 relative z-10">
              <Link href="/contact">
                <Button size="lg" className="h-16 px-12 text-lg font-bold shadow-2xl shadow-primary/20 hover:scale-105 transition-transform duration-300">
      ...
      <section className="py-24 relative" id="services">
        <div className="container px-4 mx-auto max-w-6xl">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-3xl md:text-5xl font-family-display font-bold mb-6">Our Services</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, i) => (
              <motion.div
                ...
                className={`p-10 rounded-3xl bg-white/[0.02] border border-white/10 backdrop-blur-xl hover:border-primary/50 transition-all duration-300 shadow-[0_0_40px_-15px_rgba(59,130,246,0.1)] group flex flex-col ${i === 3 ? "md:col-span-2 lg:col-span-1" : ""} ${i === 4 ? "md:col-span-2 lg:col-span-2" : ""}`}
              >
                ...
                <h3 className="text-xl font-family-display font-bold text-white mb-3">{service.title}</h3>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="container px-4 mx-auto max-w-4xl relative z-10 text-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-family-display font-bold mb-6 relative z-10">Ready to secure your business?</h2>
